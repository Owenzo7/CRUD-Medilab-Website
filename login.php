 ...
 -->
    <div class="login-form create-account">
        <form action="logprocess.php" method="post">
            ...
            <div class="form-group">
                <button type="submit"  name="login" class="btn btn-block create-account">Log-in</button>
            </div>


            <span><p>You don't have a registered account?</p> <a href="register.php"><p>Click here</p></a></span>
        </form>
